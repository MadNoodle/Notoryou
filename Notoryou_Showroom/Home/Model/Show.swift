...
struct Show {
  ...
  init(title: String, url: String, imageName:String){
    self.title = title
    self.url = "https://my.matterport.com/show/?m=\(url)&nozoom=1%27"
    self.imageName = imageName
  }
  
//  https://my.matterport.com/api/v1/player/models/tFJK9PxGchF/thumb
  static func loadShows() -> [Show] {
    return [
      Show(title: "Atelier Meraki - Exposition Ding Dong", url: "axQCCxDjUSn", imageName: "https://cdn-1.matterport.com/apifs/models/axQCCxDjUSn/images/Qu9JdtZqWpH/11.28.2017_13.11.53.jpg?t=2-cad37ffbd0c0f65fd08ec4e46c2e887259c7188a-1526479624-1"),
